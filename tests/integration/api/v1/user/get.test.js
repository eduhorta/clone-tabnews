...
describe("GET /api/v1/user", () => {
  describe("Default user", () => {
    ...
    test("With valid session created 15 days ago", async () => {
      ...
      const createdUser = await orchestrator.createUser({
        username: "UserWith15DaysValidSession",
      });
      ...
      const sessionExpiresAt = sessionObject.expires_at;
      const now = new Date(Date.now());
      sessionExpiresAt.setHours(0, 0, 0, 0);
      now.setHours(0, 0, 0, 0);

      // Transform milliseconds in days assertion
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "74c09492697e270f54ba908660ad876276ccaad3c4432c13e8fa5fe8977c83f61f51818e9a513b3c5459aed57613c353";
